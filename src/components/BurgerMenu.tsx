...
export default function BurgerMenu({ display }: IPropsBurgerMenu) {
  ...
  const burgerMenuClasses = clsx('w-full h-[calc(100%-65px)] mt-[65px] flex flex-col items-center justify-between p-8 bg-white fixed top-0 z-50 transition-all duration-300 ease-in-out', { 'left-0': display, '-left-full': !display })
