      ...
      <main
        ...
        <div className="mb-11 mt-8 max-w-3xl p-5 sm:mb-28 sm:mt-28 sm:p-0 ">
          ...
          <ol className="list-inside list-decimal space-y-2 text-sm sm:text-base">
            <li>
              {t('privacy.point1.title')}{' '}
              <span className="text-gray-light">
                {t('privacy.point1.description')}
              </span>
            </li>
            <li>
              {t('privacy.point2.title')}{' '}
              <span className="text-gray-light">
                {t('privacy.point2.description')}
              </span>
            </li>
            <li>
              {t('privacy.point3.title')}{' '}
              <span className="text-gray-light">
                {t('privacy.point3.description')}
              </span>
            </li>
            <li>
              {t('privacy.point4.title')}{' '}
              <span className="text-gray-light">
                {t('privacy.point4.description')}
              </span>
            </li>
            <li>
              {t('privacy.point5.title')}{' '}
              <span className="text-gray-light">
                {t('privacy.point5.description')}
              </span>
            </li>
            <li>
              {t('privacy.point6.title')}{' '}
              <span className="text-gray-light">
                {t('privacy.point6.description')}
              </span>
            </li>
            <li>
              {t('privacy.point7.title')}{' '}
              <span className="text-gray-light">
                {t('privacy.point7.description')}
              </span>
            </li>
          </ol>
          ...
          <ol className="list-inside list-decimal space-y-2 text-sm sm:text-base">
            <li>
              {t('tos.point1.title')}{' '}
              <span className="text-gray-light">
                {t('tos.point1.description')}
              </span>
            </li>
            <li>
              {t('tos.point2.title')}{' '}
              <span className="text-gray-light">
                {t('tos.point2.description')}
              </span>
            </li>
            <li>
              {t('tos.point3.title')}{' '}
              <span className="text-gray-light">
                {t('tos.point3.description')}
              </span>
            </li>
            <li>
              {t('tos.point4.title')}{' '}
              <span className="text-gray-light">
                {t('tos.point4.description')}
              </span>
            </li>
            <li>
              {t('tos.point5.title')}{' '}
              <span className="text-gray-light">
                {t('tos.point5.description')}
              </span>
            </li>
            <li>
              {t('tos.point6.title')}{' '}
              <span className="text-gray-light">
                {t('tos.point6.description')}
              </span>
            </li>
            <li>
              {t('tos.point7.title')}{' '}
              <span className="text-gray-light">
                {t('tos.point7.description')}
              </span>
            </li>
          </ol>
